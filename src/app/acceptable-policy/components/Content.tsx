...
const sections: Section[] = [
  ...
  },
  {
    title: "Bulk Email:",
    paragraphs: [
      'We understand that bulk email is an important mechanism for keeping people informed. However, spamming (unsolicited advertising), from the Cantech Cloud network, or spamvertising (unsolicited advertising of) sites hosted on the Cantech Cloud network is STRICTLY prohibited.',
    ],
  },
  {
    ...
    subsections: [
      {
        ...
        points: [
          ...
          "Failure to meet the acceptable criteria for bulk mail may lead to immediate termination. Additionally, if such actions have caused mail servers or IP address ranges on the Cantech Cloud network to be blacklisted, Cantech Cloud reserves the right to terminate customer account and fine the customer.",
        ],
      },
    ],
  },
