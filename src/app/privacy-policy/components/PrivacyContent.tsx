...
const sections: PrivacySection[] = [
  {
    ...
    paragraphs: [
      "This privacy policy sets out how Cantech Cloud Networks Pvt Ltd uses and protects any information that you give to Cantech Cloud Networks Pvt Ltd when you use this website.",
