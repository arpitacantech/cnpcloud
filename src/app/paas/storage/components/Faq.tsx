...
const faqs = [
  {
    question: "What is the main cloud storage importance for a small business?",
    answer:
      "Cloud storage eliminates the use of costly physical hard drives in your workplace. You save money since you only pay for the gigabytes that you use. It also keeps your files safe against local disasters such as fire or theft.",
    // meta: "Discovery",
  },
  {
 
  question: "What is the difference between File and Object Storage?",
  answer:
    "Object Storage works with huge volumes of unstructured data, such as images with no folder structure. File storage is similar to a traditional computer drive that has folders and shared access. You use Object Storage for apps and File Storage for office work.",
},
  {
    question: "Can I connect my remote database to Cantech Cloud?",
    answer:
      "Yes you can connect your remote database to our Backup Storage nodes. Our system does daily snapshots automatically to ensure that your database records are safe. You can restore these records with a single click if needed.",
    // meta: "Systems",
  },
  {
    question: "Is remote data storage safe from hackers?",
    answer:
      "We use enterprise firewalls and multi-layer encryption to block unauthorized access. All user logins have 2FA on our Cloud Storage Services to avoid account hijacking. We also perform regular security audits on our storage clusters.",
    // meta: "Quality",
  },
   {
    question: "Is my Cloud Storage scalable?",
    answer:
      "When you add files to our Cloud storage solutions, it automatically scales. You do not have to restart your server or switch your existing plan manually. The system detects the new data and adjusts your capacity in real time.",
    // meta: "Quality",
  },
   {
    question: "Does Backup Storage support automatic failover?",
    answer:
      "Our Backup Storage uses GlusterFS to replicate data across several servers. If one server goes offline, another server provides the data instantly. This redundancy prevents any interruption to your backup schedules.",
    // meta: "Quality",
  }
];
