    ...
    >
      ...
      >
        ...
        <div className="relative z-[3]">
          ...
          >
            Our technical team is available 24/7 to assist you with the setup of your server and technical problems through live chat, support tickets, and phone calls. You may also discuss with us the integration with GitHub, Redis caching, or such tools as Git, Composer, and Artisan commands.
          </motion.p>
