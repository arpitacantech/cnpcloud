    ...
    >
      ...
      >
        ...
        <div className="relative z-[3]">
          ...
          >
            We have a 24-hour online technical team. We assist you in migrations and server settings via Live Chat, Calls and Emails. You communicate with professionals who know how to optimize the PHP code and database.
          </motion.p>
