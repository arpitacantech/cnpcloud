...
const faqs = [
  {
    question: "What exactly are cloudlets in your cloud pricing plan?",
    answer:
      "A cloudlet is a small unit of server power. It contains 128MB RAM and 100MHz CPU speed. You can add many cloudlets to increase your website capacity.",
    // meta: "Discovery",
  },
  {
 
  question: "How do you calculate the total cloud pricing for my website?",
  answer:
    "We measure your resource use in units called cloudlets. One cloudlet contains 128MB RAM and 100MHz CPU power. Our system counts these units every hour to make your bill.",
},
  {
    question: "How does the hourly billing system work in cloud service costs?",
    answer:
      "Our system calculates your resource use every sixty minutes. You pay for the exact cloudlets active during that specific hour. This process prevents any waste of your budget.",
    // meta: "Systems",
  },
  {
    question: "Can I change my cloud pricing plan if my traffic grows?",
    answer:
      "You can scale your resources instantly through our dashboard. The system adds dynamic cloudlets when your traffic increases. You do not need to restart your server for these changes.",
    // meta: "Quality",
  },
   {
    question: "Do you charge extra for data security features?",
    answer:
      "We include standard security tools in the basic Cloud service costs. You get firewalls and DDoS protection without paying any extra money. Your data remains safe at no additional cost.",
    // meta: "Quality",
  },
   {
    question: "Is there any long-term contract for these cloud pricing?",
    answer:
      "We do not force users into long-term legal contracts. You can cancel your service at any time. Our cloud pricing stays fair for both monthly and hourly users.",
    // meta: "Quality",
  },
   {
    question: "What happens if I reserve cloudlets in advance?",
    answer:
      "Reserved cloudlets cost less than dynamic ones. You pay a fixed low rate for a set amount of power. This choice is best for websites with steady visitor numbers.",
    // meta: "Quality",
  },
   {
    question: "Do you offer support for setting up the cloud?",
    answer:
      "Our technical team helps you with the initial server setup. We provide this help as part of our standard service. You can contact us through chat or email for any technical doubts.",
    // meta: "Quality",
  },
   {
    question: "What is the difference between reserved and dynamic units?",
    answer:
      "Reserved units stay ready for you at a lower fixed price. Dynamic units handle sudden spikes in your website traffic. Using a mix of both helps you manage Cloud service costs better.",
    // meta: "Quality",
  },
   {
    question: "Are there any extra setup fees for these cloud plans?",
    answer:
      "We do not charge any money for starting your account. You only pay the listed Cloud Pricing for the resources you consume. There are no surprise costs at the end of the month.",
    // meta: "Quality",
  }
];
