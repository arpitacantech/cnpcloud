    ...
    >
      ...
      >
        ...
        <div className="relative z-[3]">
          ...
          >
            We help you with setup and optimization using tools like phpMyAdmin and MongoDB Compass. We use tools like BitNinja and advanced firewalls to prevent external threats. Our 24/7 staff is available through live chat, call, or the support ticket system.
          </motion.p>
