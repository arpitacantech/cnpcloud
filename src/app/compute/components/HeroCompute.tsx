  ...
  return (
    <section className="relative w-full bg-black overflow-hidden px-6 pt-32 md:pt-40 pb-24">
      ...
      <div className="relative z-20 max-w-7xl mx-auto text-center px-6 mb-20">
        ...
        <p className="max-w-3xl mx-auto text-center text-gray-500 mb-10 z-10">Power your workloads with optimized cloud compute that balances performances and cost. Designed to support modern applications, data processing and enterprise grade solutions.</p>
