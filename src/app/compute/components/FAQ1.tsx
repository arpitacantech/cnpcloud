...
const faqs = [
  {
    question: " What are cloud computing solutions?",
    answer:
      "Cloud computing is the delivery of computing services such as servers, storage, databases, networking, software, analytics, and intelligence through cloud to provide faster innovation, flexible resources, and economies of scale.",
    // meta: "Discovery",
  },
  {
    question: "What is cloud computing?",
    answer:
      "Cloud computing allows customers to use infrastructure and applications through the internet, without installing and maintaining them on premises.",
    // meta: "Collaboration",
  },
  {
    question: "How do cloud compute solutions help optimize cloud costs?",
    answer:
      "Cloud computing reduces IT costs mainly by removing upfront infrastructure expenses and shifting to a subscription model. Instead of purchasing physical servers, networking hardware, or data center space, organizations rent computing resources from cloud providers",
    // meta: "Systems",
  },
  {
    question: "Who should use cloud compute solutions?",
    answer:
      "Cloud computing can be used for various purposes, which includes data storage and backup, hosting and development platforms, web-based email services, streaming media services, data analytics, disaster recovery, test and development environments.",
    // meta: "Quality",
  },
   {
    question: "How secure are cloud compute services?",
    answer:
      "We take pride in providing a secure and solid platform to our customers with 24/7/365 world-class technical support and a 99.97% uptime SLA for all services.",
    // meta: "Quality",
  },
];
