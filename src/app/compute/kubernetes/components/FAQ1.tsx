...
const faqs = [
  {
    question: "What is Kubernetes as a service?",
    answer:
      "Kubernetes as a service (KaaS) is a model in which hyperscalers like AWS, GCP, and Azure enable you to start a Kubernetes cluster easily and quickly. Then begin deploying workloads on it instantly.",
    // meta: "Discovery",
  },
  {
 
  question: "How does Kubernetes Hosting Work?",
  answer: [
    "Firstly, the kubernetes hosting provider sets up and manages the kubernetes control plane, which consists of upgrades, patching and high availability.",
    "Worker nodes run your containerized apps and scale automatically based on the demands of workloads.",
    "Built-in load balancing, networking, storage and data management.",
    "Security features such as encryption, RBAC and network policies protect the workloads.",
    "Deploy, manage and then scale the applications while the provider handles the rest.",
  ],
  ...
  {
    question: "Who should use managed Kubernetes hosting?",
    answer:
      "Kubernetes hosting is ideal for growing startups, DevOps and engineering teams, enterprises who run production workloads, AI/Machine learning and data teams that run containerized training.",
    // meta: "Quality",
  },
   {
    question: "How secure is Kubernetes Hosting for production workloads?",
    answer:
      "Kubernetes hosting is secure for production workloads as it offers high-end security features like Role-Based Access Control (RBAC) for least privilege access, regular patching and updates, encrypted connections, firewalls, network policies and sensitive data management.",
    // meta: "Quality",
  },
];
