        ...
        <>
            ...
            <section className="py-14 md:py-16 lg:py-20">
                <div className="md:px-8 text-center">
                    ...
                    <p className="subtitle">
                        Lorem ipsum dolor, consectetur adipiscing elit. Donec congue, nisl eget molestie varius, enim ex faucibus purus
                    </p>
                </div>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12">
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div className="relative p-6 md:p-8 lg:p-10 flex flex-col gap-4">
                            ...
                            <h3 className="cc-h3">High Performance</h3>
                            <p className="cc-p">
                        ...
                        <div className="relative p-6 md:p-8 lg:p-10 flex flex-col gap-4">
                            ...
                            <h3 className="cc-h3">Enhanced Security</h3>
                            <p className="cc-p">
                        ...
                        <div className="relative p-6 md:p-8 lg:p-10 flex flex-col gap-4">
                            ...
                            <h3 className="cc-h3">Multi-Cloud Deployment</h3>
                            <p className="cc-p">
                        ...
                        <div className="relative p-6 md:p-8 lg:p-10 flex flex-col gap-4">
                            ...
                            <h3 className="cc-h3">Node Autoscaling</h3>
                            <p className="cc-p">
                        ...
                        <div className="relative rounded-2xl overflow-hidden border border-neutral-800/60 shadow-sm transform hover:translate-y-[-8px] duration-300 hover:border-[#ffffff40] hover:shadow-[0_0_8px_#ffffff40]">
                            ...
                            <div className="relative p-6 md:p-8 lg:p-10 flex flex-col gap-4">
                                ...
                                <h3 className="cc-h3">GPU Clusters</h3>
                                <p className="cc-p">
                        ...
                        <div className="relative rounded-2xl overflow-hidden border border-neutral-800/60 shadow-sm transform hover:translate-y-[-8px] duration-300 hover:border-[#ffffff40] hover:shadow-[0_0_8px_#ffffff40]">
                            ...
                            <div className="relative p-6 md:p-8 lg:p-10 flex flex-col gap-4">
                                ...
                                <h3 className="cc-h3">AI/ML & Data Processing</h3>
                                <p className="cc-p">
            ...
            <section className="py-8 md:py-10 lg:py-12">
              <motion.div
                ...
                <h2 className="cc-h2">Flexible Compute & Powerful Add-Ons for Kubernetes</h2>
                <p className="subtitle">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec congue,
                  nisl eget molestie varius.
                </p> 
              </motion.div>
              ...
              <motion.div
                ...
                <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-5">
                  ...
                  <motion.div
                    ...
                    className="relative md:col-span-2 lg:col-span-2 grayscale bg-black/50"
                  >
                    <img
