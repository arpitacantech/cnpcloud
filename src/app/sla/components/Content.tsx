...
const sections: Section[] = [
  {
    title: "",
    paragraphs: [
      'Leapswitch Networks Private Limited guarantees a 99.9% monthly network and Power uptime as per this Service Level Agreement (from here on referred to as "SLA"). Please note that terms and conditions apply. Cantech Cloud 99.9% Network Uptime SLA consists of 4 parts:',
