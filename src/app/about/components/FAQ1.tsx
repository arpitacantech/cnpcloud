...
const faqs = [
  {
    question: "What makes Cantech Cloud different from other cloud providers?",
    answer:
      "We offer enterprise hardware at prices that fit your budget. Our team provides 100% human support instead of just using bots. You get full transparency with no hidden contract requirements.",
    // meta: "Discovery",
  },
  {
    question: "Does Cantech Cloud offer real human support?",
    answer:
      "Yes. We offer 100% human assistance from real experts. Contact us through live chat, call, or email in order to get fast help.",
    // meta: "Collaboration",
  },
  {
    question: "Do you have long-term contracts?",
    answer:
      "No. Our billing model is a pay-as-you-go model. You pay only for what you use.",
    // meta: "Systems",
  },
  {
    question: "How safe is my data at Cantech Cloud?",
    answer:
      "Our Tier 3 and Tier 4 data centers are used. We have firewalls, DDoS security, and other advanced measures in our systems.",
    // meta: "Quality",
  },
  {
    question: "Can I move my current website to your cloud?",
    answer:
      "Yes. Our team will help in the migration of existing workloads and virtual machines without any charges. We simplify the migration process to save you time.",
    // meta: "Quality",
  },
  {
    question: "What hardware does Cantech Cloud use?",
    answer:
      "We use enterprise-level hardware. Our servers are based on SSD NVMe storage and the top-tier processors for high-speed.",
    // meta: "Quality",
  },
  {
    question: "Do I have full control over my resources?",
    answer:
      "Yes. You can control your domain and billing on a single dashboard and have full control of it without any special permissions.",
    // meta: "Quality",
  },
  {
    question: "Which programming languages do you support?",
    answer:
      " Our platform works with many popular software stacks. You can run Java, PHP, Python, and Ruby apps easily. We even have optimized stacks for Laravel and Docker containers.",
    // meta: "Quality",
  }
